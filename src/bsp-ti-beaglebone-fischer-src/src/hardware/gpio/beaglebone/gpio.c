...
static char *buffer = "GPIO driver\n";
...
//    gpio_base = mmap_device_io(AM335X_GPIO_SIZE, AM335X_GPIO0_BASE);
    ...
    id = resmgr_attach(
            ...
            "/dev/gpio1/12",    /* device name            */
//            "/dev/gpio0/23",    /* device name            */
...
//        return(ENOMEM);
    ...
    resmgr_msgread(ctp, &buf, /*msg->i.nbytes*/1, sizeof(msg->i));
